...
void loop() {
  ...
  Serial1.println(humidityValue);
  //Serial1.print("phValue: ");
  Serial1.println(phValue);
  //Serial1.print("moistureValue: ");
  Serial1.println(moistureValuePercent);
  //mySerial.println(temperatureValue);
  //mySerial.println(humidityValue);
}
